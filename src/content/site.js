...
export const CONTENT = {
  ...
  home: {
    es: {
      ...
      services: [
        {
          idx: "01",
          tag: "SITIO WEB",
          t: "Una web que te representa, lista en días",
          b: "Un sitio informativo claro y rápido que se ve bien en el celular: para presentar tu negocio, tus servicios y cómo te contactan. Diseño a medida, sin plantillas genéricas ni funciones que no vas a usar.",
          bullets: [
            "Sitio informativo o landing — desde $400 USD",
            "Diseño propio, rápido y optimizado para buscadores",
            "Listo en días, no en semanas",
          ],
        },
        {
          idx: "02",
      ...
      ticker: [
        { t: "svc:sitios_web", v: "disponible", k: "ok" },
        ...
        { t: "stack:react_vite", v: "producción", k: "ok" },
        { t: "deploy:railway", v: "automatico", k: "ok" },
    ...
    en: {
      ...
      services: [
        {
          idx: "01",
          tag: "WEBSITE",
          t: "A site that represents you, live in days",
          b: "A clear, fast informational site that looks right on a phone: to present your business, your services and how to reach you. Custom design, no generic templates and no features you won't use.",
          bullets: [
            "Informational site or landing page — from $400 USD",
            "Custom design, fast and search-optimized",
      ...
      ticker: [
        { t: "svc:websites", v: "available", k: "ok" },
        ...
        { t: "stack:react_vite", v: "production", k: "ok" },
        { t: "deploy:railway", v: "automatic", k: "ok" },
  ...
  about: {
    es: {
      ...
      p2: "Con Kora construyo desde sitios web informativos hasta sistemas internos completos. Trabajo con dos tipos de cliente: el que necesita una presencia web clara y rápida para su negocio, y el que necesita reemplazar un proceso manual por un sistema hecho a su medida.",
    ...
    en: {
      ...
      p2: "Through Kora I build everything from informational websites to complete internal systems. I work with two kinds of client: the one who needs a clear, fast web presence for their business, and the one who needs to replace a manual process with a system built to fit.",
